...
import GymExpensesTable from './GymExpensesTable';


const GymExpensesContent = () => {
    ...
    const handleDialogFormChange = (event) => {
        if (event.target.name === 'image') {
            setDialogForm((prevValue) => ({
                        ...
                        <Box sx={{ padding: '16px', height: 'fit-content' }}>
                            ...
                            <Stack gap='1rem'>
                                <Stack gap='5px'>
                                    ...
                                    <TextField type='number' size='small' defaultValue='0' name='amount' onChange={handleDialogFormChange} />
                                </Stack>
                                <Stack gap='5px'>
                                    <Typography sx={{ fontSize: '14px' }}>Enter Category:</Typography>
                                    <TextField size='small' placeholder='Please type Expenses category here' name='category' onChange={handleDialogFormChange} />
                                </Stack>
                                <Stack gap='5px'>
                                    <Typography sx={{ fontSize: '14px' }}>Comment:</Typography>
                                    <TextField multiline minRows={3} size='small' placeholder='Please type comment here' name='comment' onChange={handleDialogFormChange} />
                                </Stack>
                                <Stack gap='5px'>
                                ...
                                <Stack gap='5px'>
                                    ...
                                    <TextField size='small' type='file' placeholder='Choose File' name='image' onChange={handleDialogFormChange} />
                                </Stack>
                                <Button variant='contained' onClick={handleAddExpense} sx={{ width: 'fit-content', ml: 'auto', mt: '5px' }}>Add Expenses</Button>
                            </Stack>
                        </Box>
                    </Dialog>
                    <Button
...
export default GymExpensesContent
