...
const CompaniesContent = () => {
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Stack direction='column' justifyContent='center' alignItems='center' padding='1rem' width='100%' gap='2rem' mt='20px'>
                <Stack sx={{ borderRadius: '10px', width: '100%', gap: '20px' }}>
                    <Stack direction='row' gap='2%'>
                        <Paper elevation={6} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative', height: '126px', padding: '20px', flex: 1, bgcolor: 'white', borderRadius: '8px' }}>
                        ...
                        <Paper elevation={6} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', height: '126px', padding: '20px', flex: 1, bgcolor: '#2065D1', color: 'white', borderRadius: '8px' }}>
