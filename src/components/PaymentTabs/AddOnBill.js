        ...
        <Box>
            ...
            <Stack direction='row' gap='1rem' padding='1rem' sx={{ width: '100%' }}>
                <Stack sx={{ border: '1px solid #D8D8D8', borderRadius: '10px', width: '220px' }}>
                    <Typography sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', py: '4%', fontSize: '14px', width: '100%', height: '40%', borderRadius: '10px 10px 0 0', borderBottom: '1px solid #D8D8D8' }}>
                        <b>Current Balance :</b>
                    </Typography>
                ...
                <Stack sx={{ border: '1px solid #D8D8D8', borderRadius: '10px', gap: '12px', width: '500px', py: '10px', px: '15px' }}>
                    ...
                    <Stack direction='row' alignItems='center' gap='2rem'>
                        ...
                        <Typography sx={{ bgcolor: '#072534', color: 'white', width: '55px', textAlign: 'center', borderRadius: '5px' }}>
                            ₹ <span> 0</span>
                        </Typography>
                    </Stack>
                </Stack>
