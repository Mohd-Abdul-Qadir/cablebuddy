...
import { Box, Typography, Stack, Button, TextField, InputAdornment, MenuItem, Divider, ButtonBase, Table, TableHead, TableBody, TableRow, TableCell } from '@mui/material'
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Stack direction='row' padding='1rem' sx={{ width: '100%' }}>
                <Stack direction='column' gap='2rem'>
                    ...
                    <Stack direction='row'>
                        ...
                        <Typography>31-May-2023 <ButtonBase sx={{ bgcolor: '#072534', color: 'white', px: '5px', borderRadius: '5px' }}>Edit</ButtonBase></Typography>
                    </Stack>
                    <Stack>
                    ...
                    <Table sx={{ padding: '0px' }}>
                        <TableHead>
                            <TableRow sx={{ color: 'black', borderTop: '1px solid #D8D8D8', borderBottom: '1px solid #D8D8D8' }}>
                                ...
                                <TableCell sx={{ color: 'black' }}><b>Current Subscription (1)</b></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
            ...
            <Stack direction='row' justifyContent='space-between' py='1rem' borderTop='1px solid #D8D8D8' mt='10px'>
                <Button variant='contained' endIcon={<TelegramIcon />} sx={{ bgcolor: '#072534' }}>Renew</Button>
                <Button variant='contained' endIcon={<TelegramIcon />}>Renew From Today</Button>
                <Button variant='contained' endIcon={<TelegramIcon />}>Change Subscription</Button>
            </Stack>
        </Box>
    )
}
