...
export default function CustomersWater() {
    ...
    const handleAddCustomer = () => {
        navigate(`/water/addcustomers`);
    };

    const handleCustomerDetails = (id) => {
        navigate(`/water/customerdetails`);
    };
    ...
    return (
        <>
            ...
            <Container>
                <Box sx={{ mb: '1rem' }}>
                    <Typography sx={{ color: '#0C3547', fontWeight: '400', fontSize: '48px' }}>Water Customers</Typography>
