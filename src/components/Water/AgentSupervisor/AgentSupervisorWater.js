...
import AddAgentWater from './AddAgentWater';
import AgentSupervisorCards from './AgentSupervisorCards';
...
export default function AgentSupervisorWater() {
        ...
        <>
            ...
            <Container>
                <Box sx={{ marginBottom: '20px' }}>
                    <Typography sx={{ color: '#0C3547', fontWeight: '400', fontSize: '48px' }}>Water Agents</Typography>
                    <Box sx={{ display: 'flex', gap: '1rem' }}>
                        <AddAgentWater />
                    </Box>
                </Box>
                <AgentSupervisorCards />
                <Paper
                    elevation={3}
                    sx={{
                        display: 'flex',
