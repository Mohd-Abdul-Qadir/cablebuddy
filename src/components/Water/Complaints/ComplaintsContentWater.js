...
import { Box, Typography, Button, Stack, Pagination, Dialog, Divider, TextField } from '@mui/material';
...
import OpenTableWater from './OpenTableWater';
import InProgressTableWater from './InProgressTableWater';
import ResolvedTableWater from './ResolvedTableWater';

const ComplaintsContentWater = () => {
    ...
    return (
        ...
        >
            <Box sx={{ width: '100%', px: '20px' }}>
                <Box>
                    <Typography sx={{ color: '#0C3547', fontWeight: '400', fontSize: '48px' }}>Complaints</Typography>
                        ...
                        <Box sx={{ padding: '16px', height: 'fit-content' }}>
                            ...
                            <Stack gap="1rem">
                                ...
                                <Stack gap="5px">
                                    ...
                                    <Select size="small" value={dialogStatus} onChange={handleDialogStatus} displayEmpty>
                                ...
                                <Stack gap="5px">
                                    ...
                                    <Select size="small" id="demo-select-small" value={agent} onChange={handleAgent} displayEmpty>
                                ...
                                <Button variant="contained" sx={{ width: 'fit-content', ml: 'auto', mt: '5px' }}>
                                    Add Complaint
                                </Button>
                            </Stack>
                        </Box>
                    ...
                    >
                        <Button
                            ...
                            sx={{
                                ...
                                fontWeight: '600',
                                fontSize: '13px',
                                color: active === 'Open' ? 'white' : 'black',
                                background: active === 'Open' ? '#2065D1' : '',
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                fontWeight: '600',
                                fontSize: '13px',
                                color: active === 'InProgress' ? 'white' : 'black',
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                fontWeight: '600',
                                fontSize: '13px',
                                color: active === 'Resolved' ? 'white' : 'black',
                                background: active === 'Resolved' ? '#2065D1' : '',
                            ...
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DemoContainer components={['DatePicker', 'DatePicker']} sx={{ padding: '0px' }}>
                                    <Box sx={{ overflow: 'auto', maxWidth: '100%' }}>
                                        <DatePicker label="Select Date" onChange={(newValue) => setValue(newValue)} />
                                    </Box>
                                </DemoContainer>
...
export default ComplaintsContentWater;
