        ...
        <Box sx={{
            ...
            <Stack direction='row' padding='1rem' width='100%' gap='2rem'>
                <List sx={{ border: '1px solid #D8D8D8', borderRadius: '8px', padding: 0, width: '25%', height: 'fit-content', bgcolor: 'white' }}>
                    <ListItemButton onClick={() => handleTabClick('Excel&Pdf')}
                        sx={{
                            display: 'flex',
                            gap: '10px',
                    ...
                    <ListItemButton onClick={() => handleTabClick('GstInvoice')}
                        sx={{
                            display: 'flex',
                            gap: '10px',
                    ...
                    <ListItemButton onClick={() => handleTabClick('AreaSummary')}
                        ...
                        <ListItemIcon sx={{ minWidth: 0 }}>
                            <Icon icon="carbon:summary-kpi-mirror" width='24px' color={activeTab === 'AreaSummary' ? 'white' : 'grey'} />
                        </ListItemIcon>
                        <ListItemText primary="Area Summary" />
                    </ListItemButton >
                    <ListItemButton onClick={() => handleTabClick('Profit&Loss')}
                        sx={{
                            py: '0px',
                            display: 'flex',
                            gap: '10px',
