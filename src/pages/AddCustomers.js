...
const AddCustomers = () => {
    ...
    const handleAddSubmit = async (e) => {
        ...
        e.preventDefault();
        const { name, billingName, billingArea, billingNo, mobileNo1, mobileNo2, email, securityDeposit, address, gstNo, customerCode, remark, stbName, stbNumber, cardNumber, membershipNo, startDate, openingBalanceRadio, openingBalanceAmount, additionalChargeDiscount, additionalChargeRadio, billDurationRadio, billDurationSelect, billTypeRadio, gstTypeRadio } = inputData;
    ...
    return (
        <Box sx={{ padding: '1%', width: '100%' }}>
            ...
            <Stack gap={5}>
                ...
                <Stack direction='column' justifyContent='center' alignItems='center' gap='2rem' sx={{ width: '100%', border: '1px solid #D8D8D8', bgcolor: 'white', borderRadius: '10px' }}>
                    <Typography sx={{ px: '2%', py: '1%', fontWeight: '600', fontSize: '16px', width: '100%', borderRadius: '10px 10px 0 0', borderBottom: '1px solid #D8D8D8', bgcolor: 'rgba(145, 158, 171, 0.12)' }}>Hardware Detail
                    </Typography>
                    <Stack gap='1rem' sx={{ width: '100%', padding: '1rem' }}>
                        <Stack fullWidth direction='row' gap='1rem'>
                            <TextField
                        ...
                        <Button variant="contained" onClick={() => { onclickShowCard() }} startIcon={<AddCircleOutlineIcon />} sx={{ width: 'fit-content' }}>Add</Button>

                        <Divider sx={{ my: '10px' }} />
                        {
                            showCard ? (
                                <Stack sx={{ border: '1px solid #D8D8D8', borderRadius: '10px', padding: '1rem', width: '300px', gap: '1rem', position: 'relative' }}>
                    ...
                    <Stack direction='row' gap='1rem' fullWidth sx={{ width: '100%', padding: '1rem' }}>
                        <Stack sx={{ border: '1px solid #D8D8D8', borderRadius: '10px', padding: '1rem', width: '50%' }}>
                            <Stack fullWidth gap='2rem'>
                                ...
                                <Stack>
                                    <Typography>Till <b>30-Apr-2023</b> opening balance is :</Typography>
                                    <FormControl component="fieldset">
                                        <RadioGroup aria-label="options"
                                            ...
                                            <FormControlLabel value="outstanding" control={<Radio />} label="Outstanding" labelPlacement="end" />
